...
const proposeTransaction = async (mints) => {
    try {
        ...
        const transactionHash = await getTransactionHash(nonce, safeTxGas, resliceData);
        ...
        const body = {
            ...
            body: JSON.stringify({
                ...
                sender: initContracts_1.mteWallet.address,
                signature,
                origin: "Merge to earn"
            }),
            method: "POST"
        };
        const res = await (0, fetchPost_1.default)(baseUrl + endpoint, body);
